...
import com.kkdj.airouter.mapper.ImageGenerationRecordMapper;
...
import com.kkdj.airouter.metrics.AIMetricsCollector;
import com.kkdj.airouter.service.*;
    ...
    public ImageGenerationResponse generateImage(ImageGenerationRequest request, Long userId, Long apiKeyId, String clientIp) {
        ...
        try {
            ...
            requestLogService.logRequest(RequestLogDTO.builder()
                    ...
                    .totalTokens(actualImageCount * 1000)
                    .cost(actualCost)
                    .duration((int) duration)
                    .status("success")
                    .clientIp(clientIp)
            ...
            // 收集监控指标
            aiMetricsCollector.recordRequest(modelKey, userId, apiKeyId != null ? apiKeyId.toString() : null);
            aiMetricsCollector.recordTokens(modelKey, actualImageCount * 1000);
            aiMetricsCollector.recordResponseTime(modelKey, duration);
            ...
            requestLogService.logRequest(RequestLogDTO.builder()
                    ...
                    .clientIp(clientIp)
                    .build());
            aiMetricsCollector.recordError(modelKey, "IMAGE_ERROR");
