...
VALUES ('qwen', '通义千问', 'https://dashscope.aliyuncs.com/compatible-mode', 'YOUR_BAILIAN_API_KEY', 'active', 100),
       ('zhipu', '智谱AI(百炼)', 'https://dashscope.aliyuncs.com/compatible-mode', 'YOUR_BAILIAN_API_KEY', 'active', 90),
       ('deepseek', 'DeepSeek(百炼)', 'https://dashscope.aliyuncs.com/compatible-mode', 'YOUR_BAILIAN_API_KEY', 'active', 80);
...
(2, 'glm5.1', 'GLM 5.1', 'chat', '智谱AI超强性能模型，高级编码能力、强大推理以及工具调用能力', 204800, 0.05, 0.05, 90, 1),
(2, 'glm-5', 'GLM 5', 'chat', '智谱AI免费模型，最新基座模型的普惠版本', 204800, 0.0001, 0.0001, 80, 0),

-- DeepSeek模型（通过阿里云百炼调用）
(3, 'deepseek-v4-pro', 'DeepSeek V4 Pro', 'chat', 'DeepSeek V4旗舰模型，支持深度思考', 65536, 0.01, 0.02, 100, 1),
(3, 'deepseek-v4-flash', 'DeepSeek V4 Flash', 'chat', 'DeepSeek V4快速版', 32768, 0.001, 0.002, 100, 0),
(3, 'deepseek-v3.2', 'DeepSeek V3.2', 'chat', 'DeepSeek V3.2代码模型', 32768, 0.001, 0.002, 90, 0),

-- 绘图模型（通过阿里云百炼调用）
(1, 'qwen-image-plus', 'Qwen Image Plus', 'image', '通义万相文生图模型', 0, 0.08, 0, 100, 0),
(1, 'qwen-image-2.0', 'Qwen Image 2.0', 'image', '通义万相2.0文生图模型', 0, 0.08, 0, 90, 0);
