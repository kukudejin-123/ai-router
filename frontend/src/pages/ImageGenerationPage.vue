            ...
            <a-form-item label="选择模型">
              <a-radio-group v-model:value="formData.model">
                <a-radio value="qwen-image-plus">
                  <span style="font-weight: bold">通义万相 qwen-image-plus</span>
                  <span style="color: #999; margin-left: 8px">(0.08元/张)</span>
                </a-radio>
                <a-radio value="qwen-image-2.0">
                  <span style="font-weight: bold">通义万相 qwen-image-2.0</span>
                  <span style="color: #999; margin-left: 8px">(0.12元/张)</span>
                </a-radio>
              </a-radio-group>
            </a-form-item>
